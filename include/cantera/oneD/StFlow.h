...
public:
    ...
    StFlow(PengRobinsonGasPhase* ph = 0, size_t nsp = 1, size_t points = 1);
    ...
    void setThermo(PengRobinsonGasPhase& th) {
        m_thermo = &th;
    }
...
public:
    ...
    AxiStagnFlow(PengRobinsonGasPhase* ph = 0, size_t nsp = 1, size_t points = 1) :
...
public:
    ...
    FreeFlame(PengRobinsonGasPhase* ph = 0, size_t nsp = 1, size_t points = 1);
